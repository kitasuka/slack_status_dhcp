...
研究室にスマホを持ち込んでだときに，スマホが研究室のWi-Fiに接続したことを検出して，そのスマホユーザのSlackアカウントのステータスを変更します．
このために，研究室のネットワーク上にRaspberry PiなどのPC上でこのSlackアプリのスクリプトを常時動作させておきます．
スマホのMACアドレス登録やステータスの自動変更などの設定は，Slackアプリのホーム画面で行います．

研究室じゃなくて自宅で家族のSlackワークスペースがある場合も同様に．
